...
<body>
    <img class="bg" src="bg.jpg" alt="IMS ENGINEERING COLLEGE">
   <div class="container">
       <h1>
           Welcome to IMS Engineering College Darjeeling trip
       </h1>
       <p>Enter your details to confirm your participation in the trip</p>
       <?php
      echo "<p class='apple'>Thanks for submitting your form.We are happy to see you joinning us for the Darjeeling trip</p>";
